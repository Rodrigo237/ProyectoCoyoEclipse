	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cuestionario_seleccion_segundo);
		  ...
		  Date date = new Date();
	        ...
	        algun10 = (RadioButton)findViewById(R.id.algunas10);
	        casi10 = (RadioButton)findViewById(R.id.casisiempre10);
	        ...
	        algun11 = (RadioButton)findViewById(R.id.algunas11);
	        casi11 = (RadioButton)findViewById(R.id.casisiempre11);
	        ...
	        algun12 = (RadioButton)findViewById(R.id.algunas12);
	        casi12 = (RadioButton)findViewById(R.id.casisiempre12);
	        siempre12 = (RadioButton)findViewById(R.id.siempre12);

	        radioGroupP10 = (RadioGroup)findViewById(R.id.radioGroupPregunta10);
	        radioGroupP11 = (RadioGroup)findViewById(R.id.RadioGroupPregunta11);
	        radioGroupP12 = (RadioGroup)findViewById(R.id.radioGroupPregunta12);
	 ...
	 public void siguienteSelecionSegundo(View view)
	    {
