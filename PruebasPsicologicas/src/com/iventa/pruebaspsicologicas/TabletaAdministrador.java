...
public class TabletaAdministrador extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		monitor_01.setText("Tableta número: " + leer_tableta());
...
//		monitor_05.setText("Número de serie: " + android.os.Build.SERIAL);
...
//			la_tableta = (String) monitor_01.getText();
	...
	public void exhibe_registros() {
		texto_contenido_periodo.setText("Entrevistas del período:" + "\n");
...
//		texto_contenido_periodo.append("Muestras con orina = " + fuenteDeCuestionarioBasico.cuentaPipiPeriodoEnBasico().toString() + "\n");
		...
		texto_contenido_periodo.append("No están en su domicilio = " + fuenteDeCuestionarioBasico.cuentaNoEnDomicilioPeriodoEnBasico().toString());
...
//		texto_contenido_hoy.append("Muestras con orina = " + fuenteDeCuestionarioBasico.cuentaPipiHoyEnBasico().toString() + "\n");
		...
		texto_contenido_hoy.append("No están en su domicilio = " + fuenteDeCuestionarioBasico.cuentaNoEnDomicilioHoyEnBasico().toString());
	}
...
//		emailIntent.setType("text/plain");
		...
		emailIntent.putExtra(Intent.EXTRA_TEXT, "Hola. Este es un correo de campo y con archivo adjunto."); // * configurar email aquí!
		emailIntent.putExtra(Intent.EXTRA_STREAM, uri);

		try {
			startActivity(Intent.createChooser(emailIntent, "Enviar correo electrónico mediante:"));        
