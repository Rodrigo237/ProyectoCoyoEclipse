...
public class CuestionarioSeleccion extends Activity{
	...
	RadioButton nunca1,muy1,algunas1,casisiempre1,siempre1;
	RadioButton  nunca2,muy2,algunas2,casisiempre2,siempre2;
    RadioButton  nunca3,muy3,algunas3,casisiempre3,siempre3;
    RadioButton  nunca4,muy4,algunas4,casisiempre4,siempre4;
    RadioButton  nunca5,muy5,algunas5,casisiempre5,siempre5;
    RadioButton  nunca6,muy6,algunas6,casisiempre6,siempre6;
    RadioButton  nunca7,muy7,algunas7,casisiempre7,siempre7;
    RadioButton  nunca8,muy8,algunas8,casisiempre8,siempre8;
    RadioButton  nunca9,muy9,algunas9,casisiempre9,siempre9;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroupP1 = (RadioGroup)findViewById(R.id.radioGroupPregunta1);
        radioGroupP2 = (RadioGroup)findViewById(R.id.RadioGroupPregunta2);
        radioGroupP3 = (RadioGroup)findViewById(R.id.RadioGroupPregunta3);
        radioGroupP4 = (RadioGroup)findViewById(R.id.RadioGroupPregunta4);
        radioGroupP5 = (RadioGroup)findViewById(R.id.RadioGroupPregunta5);
        radioGroupP6 = (RadioGroup)findViewById(R.id.RadioGroupPregunta6);
        radioGroupP7 = (RadioGroup)findViewById(R.id.RadioGroupPregunta7);
        radioGroupP8 = (RadioGroup)findViewById(R.id.RadioGroupPregunta8);
        radioGroupP9 = (RadioGroup)findViewById(R.id.RadioGroupPregunta9);
	
        nunca1 = (RadioButton)findViewById(R.id.nunca1);
        muy1  = (RadioButton)findViewById(R.id.muy1);
        algunas1 = (RadioButton)findViewById(R.id.algunas1);
        casisiempre1 = (RadioButton)findViewById(R.id.casisiempre1);
        ...
        algunas2 = (RadioButton)findViewById(R.id.algunos2);
        casisiempre2 = (RadioButton)findViewById(R.id.casisiempre2);
        ...
        algunas3 = (RadioButton)findViewById(R.id.algunos3);
        casisiempre3 = (RadioButton)findViewById(R.id.casisiempre3);
        ...
        algunas4 = (RadioButton)findViewById(R.id.algunos4);
        casisiempre4 = (RadioButton)findViewById(R.id.casisiempre4);
        ...
        algunas5 = (RadioButton)findViewById(R.id.algunos5);
        casisiempre5 = (RadioButton)findViewById(R.id.casisiempre5);
        ...
        algunas6 = (RadioButton)findViewById(R.id.algunos6);
        casisiempre6 = (RadioButton)findViewById(R.id.casisiempre6);
        ...
        algunas7 = (RadioButton)findViewById(R.id.algunos7);
        casisiempre7 = (RadioButton)findViewById(R.id.casisiempre7);
        ...
        algunas8 = (RadioButton)findViewById(R.id.algunos8);
        casisiempre8 = (RadioButton)findViewById(R.id.casisiempre8);
        ...
        algunas9 = (RadioButton)findViewById(R.id.algunos9);
        casisiempre9 = (RadioButton)findViewById(R.id.casisiempre9);
