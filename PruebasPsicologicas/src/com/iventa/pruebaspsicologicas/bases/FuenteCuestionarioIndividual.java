...
import com.iventa.pruebaspsicologicas.bases.SQLiteOpenHelperCuestionario.TablaCuestionarioIndividual;
...
// Procedimiento por eliminar.
    ...
    private ClasesIndividual cursorToIndividual(Cursor cursor) { 
	    ...
	    if (la_FechaToma.length() == 10) {
	    	año_FechaToma = Integer.valueOf(la_FechaToma.substring(6,10));
	   		la_EdadActual = String.valueOf((calendar.get(Calendar.YEAR) - año_FechaToma) + la_EdadAyer);
	    }
