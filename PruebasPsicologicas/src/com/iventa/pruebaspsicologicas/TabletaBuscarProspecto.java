...
public class TabletaBuscarProspecto extends Activity implements OnItemClickListener {
    ...
    private static String la_version;
	...
	private Button botonCrearCuestionario;
    ...
    protected void onCreate(Bundle savedInstanceState) { 
        ...
        setContentView(R.layout.activity_buscar_prospectos); 
        ...
        botonCrearCuestionario	= (Button) findViewById(R.id.botonCrearCuestionario);
...
//		botonCrearCuestionario.setWidth(ancho_de_botones);
		...
		botonCrearCuestionario.setWidth(50);
        ...
        botonSeleccionarArea.setVisibility(-1);
        botonSeleccionarFamilia.setVisibility(-1);
        botonSeleccionarManzana.setVisibility(-1);
        botonCrearCuestionario.setVisibility(-1);
        textoProcesando.setVisibility(-1);
...
//    	campoVivienda.setText("");
	...
	public void crearCuestionario(View v) {
		...
		fuenteDeCuestionarioBasico.open(); 
		Integer cantidad_de_registros_en_morbilidad = fuenteDeCuestionarioBasico.cuentaRegistrosEnMorbilidad(); 

		fuenteDeCuestionarioIndividual = new FuenteCuestionarioIndividual(this);
    	fuenteDeCuestionarioIndividual.open();

		comando_SQL_registro = "SELECT registro," +
										"cadena, municipio, ageb, area, manzana, vivienda, " +
										"nombre, paterno, materno, sexo, edad, fechatoma, p72 " +
    	...
    	Integer el_campoSecuencia	= cantidad_de_registros_en_morbilidad + 1;
    	...
    	fuenteDeCuestionarioBasico.crearCuestionarioBasico(
    			el_campoSecuencia, el_campoRegistro,
        		el_campoCadena, el_campoMunicipio,
...
//		} // Fin de if (matrizBasico[0] != null )
	...
	public void ventanaAnterior(View v) {
		Intent i = new Intent(TabletaBuscarProspecto.this, MainActivity.class);
		startActivity(i);
    }
}
